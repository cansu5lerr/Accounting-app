...
// import { Button, Card, CardContent, Grid, TextField, Typography, Avatar, SvgIcon, Box, Stack } from '@mui/material';
...
//   const [incomeDate, setIncomeDate] = useState(new Date()); // Tarih başlangıç değerini ayarlayın
...
//       setIncomeName('');
//       setIncomeAmount('');
//       setIncomeDate(new Date()); // Tarihi sıfırlayın
//     }
//   };
...
//     <Button
// variant="contained"
// style={{ backgroundColor: '#9400FF', color: '#fff' }}
