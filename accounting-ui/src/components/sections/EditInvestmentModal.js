...
//         onClose(); 
//       } else {
//         console.error('Yatırımı güncelleme başarısız oldu');
//       }
//     } catch (error) {
//       console.error('Yatırımı güncelleme sırasında bir hata oluştu', error);
//     } finally {
...
//               <DatePicker
//                 value={dayjs(editedInvestment.investmentDate)}              
//                 format="YYYY/MM/DD"
